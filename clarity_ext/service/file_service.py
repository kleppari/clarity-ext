...
class FileService:
    ...
    def local_shared_file(self, file_handle, mode='r', extension="", modify_attached=False, file_name_contains=None):
        ...
        local_file_handle = "{}_{}.{}".format(artifact.id, file_handle.replace(" ", "_"), extension)
        directory = os.path.join(self.downloaded_path, local_file_handle)
        downloaded_path = os.path.abspath(directory)
        cache_directory = os.path.abspath(".cache")
        cache_path = os.path.join(cache_directory, local_file_handle)
